...
class Mesh extends Drawable {
    ...
    column1: Float32Array;
    column2: Float32Array;
    column3: Float32Array;
    column4: Float32Array;
    ...
    createInstanceVBOs(colors: Float32Array, column1: Float32Array, column2: Float32Array,
        column3: Float32Array, column4: Float32Array) {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, this.column1, gl.STATIC_DRAW);

        gl.bindBuffer(gl.ARRAY_BUFFER, this.bufTransformCol2);
        gl.bufferData(gl.ARRAY_BUFFER, this.column2, gl.STATIC_DRAW);

        gl.bindBuffer(gl.ARRAY_BUFFER, this.bufTransformCol3);
        gl.bufferData(gl.ARRAY_BUFFER, this.column3, gl.STATIC_DRAW);

        gl.bindBuffer(gl.ARRAY_BUFFER, this.bufTransformCol4);
        gl.bufferData(gl.ARRAY_BUFFER, this.column4, gl.STATIC_DRAW);
    }
};
